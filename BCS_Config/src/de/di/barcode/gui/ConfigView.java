...
public class ConfigView extends FrameView implements ConfigChangeListener {
    ...
    public ConfigView(SingleFrameApplication app) {
        ...
        initComponents();
        String tabString = "de.di.barcode.gui.GeneralTab,de.di.barcode.gui.FilesTab,de.di.barcode.gui.LicenseTab";
        if (tabString != null) {
    ...
    private void addTabs() {
        ...
        for (String tabName : tabs) {
            try {
                ...
                if (tab instanceof de.di.barcode.gui.FilesTab) {
                    filesTab = (FilesTab) tab;
                }
                if (tab instanceof de.di.barcode.gui.GeneralTab) {
