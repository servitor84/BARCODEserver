...
public class LicenseTab extends javax.swing.JPanel implements ConfigTab {
    ...
    private static final String bundleName = "de/di/barcode/gui/resources/LicenseTab";
    ...
    private void initComponents() {
        ...
        org.jdesktop.application.ResourceMap resourceMap = org.jdesktop.application.Application.getInstance(de.di.barcode.gui.ConfigApp.class).getContext().getResourceMap(LicenseTab.class);
...
private void changeLicenseButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_changeLicenseButtonActionPerformed
    ...
    private void loadProductInfo() {
        ...
        InputStream in = Thread.currentThread().getContextClassLoader().getResourceAsStream("de/di/barcode/resources/product.properties");
